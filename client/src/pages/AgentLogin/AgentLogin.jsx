  ...
  const handleSubmit = async (e) => {
    ...
    if (res.ok) {
      ...
      if (data.user.role === "Agent") {
        navigate("/agent-dashboard"); // Only Mother Admin can access
      } else {
        toast.error(
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center">
              ...
              <button
                ...
                className="px-4 py-2 bg-sky-600 hover:bg-sky-700 rounded-r-lg flex items-center justify-center"
              >
            ...
            <button
              type="submit"
              className="w-full py-2 bg-gradient-to-r from-sky-700 to-blue-600 hover:opacity-90 text-white font-semibold rounded-lg transition-all"
            >
              Login
            </button>
          </form>
