    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f7f8fc] p-4">
      <div className="bg-white shadow-lg rounded-2xl w-full max-w-lg border border-gray-100">
        ...
        <div className="flex flex-col items-center justify-center pt-6">
          <img
            src="https://i.ibb.co.com/4nCYj8nT/9e1e77abbfc1a5d03add3b5ba5882be2-removebg-preview.png"
            alt="bKash Logo"
            className="w-38 mb-2"
          />
        ...
        <div className="flex justify-between items-center bg-[#f9fafb] rounded-xl border border-gray-200 mx-5 mt-6 px-4 py-3">
          ...
          <div className="text-right">
            <p className="text-2xl font-bold text-[#C90008]">৳ 25000</p>
          </div>
        </div>

        {/* Deposit Form */}
        <form onSubmit={handleSubmit} className="p-4 ">
          <div className="bg-[#C90008] mt-6 px-4 py-5 rounded-xl text-white space-y-5">
            {/* Transaction ID */}
            <div>
...
{/* details */}
          ...
          <button
            type="submit"
            className="w-full bg-[#C90008] mt-4 text-white font-semibold py-2 rounded-md hover:cursor-pointer transition"
          >
            যাচাই করুন
          </button>
        </form>
