...
const SubAgent = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/sub-agents?search=${searchTerm}&page=${currentPage}&limit=${limit}`);
  ...
  return (
    <div className="container mx-auto p-6 bg-gray-50 rounded-lg shadow-lg">
      <h2 className="text-3xl font-bold mb-6 text-gray-800">Sub Agents List</h2>
